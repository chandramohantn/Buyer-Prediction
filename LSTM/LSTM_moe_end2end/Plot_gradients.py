...
def main():
	...
	m11 = LSTM(128, return_sequences=True)(input1)
	m12 = LSTM(64)(m11)
	m13 = Dense(2, activation='softmax')(m12)

	s = 64
	print('Build expert 2...')
	input2 = Input(shape=(max_len, s))
	m21 = LSTM(128, return_sequences=True)(input2)
	m22 = LSTM(64)(m21)
	m23 = Dense(2, activation='softmax')(m22)

	s = 194
	print('Build expert 3...')
	input3 = Input(shape=(max_len, s))
	m31 = LSTM(128, return_sequences=True)(input3)
	m32 = LSTM(64)(m31)
	m33 = Dense(2, activation='softmax')(m32)
	...
	model.load_weights('model/best_lstm_moe_end2end_buy_w')
	...
	for i in range(10):
		...
		c = plt.colorbar(h)
		plt.tight_layout()
		plt.savefig('grad_plots/Gradients_buyers_moe_end2end_cat' + str(i) + '.png')
		plt.close()
		...
		c = plt.colorbar(h)
		plt.tight_layout()
		plt.savefig('grad_plots/Gradients_buyers_moe_end2end_item' + str(i) + '.png')
		plt.close()
		...
		c = plt.colorbar(h)
		plt.tight_layout()
		plt.savefig('grad_plots/Gradients_buyers_moe_end2end_time' + str(i) + '.png')
		plt.close()
		...
		cbar = plt.colorbar(h)
		plt.tight_layout()
		plt.savefig('grad_plots/Gradients_buyers_moe_end2end_att' + str(i) + '.png')
		plt.close()
